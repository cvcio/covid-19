<template>
	<v-dialog :value="dialogEmbed" @click:outside="$store.commit('set_dialogEmbed', false)" width="600px" transition="slide-y-reverse-transition" fullscreen>
		<v-card tile>
			<v-card-title>
