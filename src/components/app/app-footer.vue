<template>
	<v-footer app absolute height="44" class="elevation-0 pa-0 px-4" :class="$vuetify.breakpoint.smAndDown ? '' : ''">
		...
		<v-spacer/>
		<a class="caption"  href="https://cvcio.org/" target="_blank">
			<span class="">
				<span class="hidden-sm-and-down mr-2">a collaboration with</span>
				<span class="">CVCIO</span>
			</span>
		</a>
	</v-footer>
</template>
